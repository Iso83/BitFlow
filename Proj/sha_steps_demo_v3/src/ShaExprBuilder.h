...
class ExprBuilder {
  public:
    ...
    BitFlow::Core::AST::Expr* Or(BitFlow::Core::AST::Expr* a, BitFlow::Core::AST::Expr* b) {
        return Op(BitFlow::Core::AST::OpType::Or, {a, b});
    }

    BitFlow::Core::AST::Expr* Not(BitFlow::Core::AST::Expr* x) {
        return Op(BitFlow::Core::AST::OpType::Not, {x});
    }
  ...
  private:
    BitFlow::Core::AST::Expr* NewNode(BitFlow::Core::AST::OpType op,
        ...
        e->op = op;
        e->inputs.assign(inputs.begin(), inputs.end());
        return e;
    }

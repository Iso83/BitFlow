...
int TestBigSigma0_ParseBuilderSimplifyEmitVerify() {
    ...
    auto rewrittenVar = MakeSigmaEngine().ApplyUntilStable(parsedVar.root);
    ...
    const auto parsedEval = Eval::EvaluateConstant(MakeSigmaEngine().ApplyUntilStable(parsedConst.root), 32);

    Builder b;
    const auto builderEval = Eval::EvaluateConstant(MakeSigmaEngine().ApplyUntilStable(b.BigSigma0(b.Const(x))), 32);
...
int TestBigSigma1_ParseBuilderSimplifyEmitVerify() {
    ...
    Builder b;
    const auto builderEval = Eval::EvaluateConstant(MakeSigmaEngine().ApplyUntilStable(b.BigSigma1(b.Const(x))), 32);
...
int TestSmallSigma0_ParseBuilderSimplifyEmitVerify() {
    ...
    Builder b;
    const auto builderEval = Eval::EvaluateConstant(MakeSigmaEngine().ApplyUntilStable(b.SmallSigma0(b.Const(x))), 32);
...
int TestSmallSigma1_ParseBuilderSimplifyEmitVerify() {
    ...
    Builder b;
    const auto builderEval = Eval::EvaluateConstant(MakeSigmaEngine().ApplyUntilStable(b.SmallSigma1(b.Const(x))), 32);

...
int TestExprPrinter_MinimalParentheses() {
    auto parsedA = BitFlow::IO::Parse("(a - b) + c");
    BF_TEST(BitFlow::IO::ToString(parsedA.root, parsedA.idToName) == "a - b + c");
    ...
    auto parsedD = BitFlow::IO::Parse("a * (b * c)");
    BF_TEST(BitFlow::IO::ToString(parsedD.root, parsedD.idToName) == "a * b * c");

    auto parsedE = BitFlow::IO::Parse("-(a + b)");
    BF_TEST(BitFlow::IO::ToString(parsedE.root, parsedE.idToName) == "-(a + b)");
...
int main() {
    ...
    BF_RUN_TEST(TestExprPrinter_MinimalParentheses);

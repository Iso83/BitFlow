...
#include <BitFlow/functions/FunctionDefinition.h>
...
using IFunctionResolver = BitFlow::IO::IFunctionResolver;
using FunctionResolveContext = BitFlow::IO::FunctionResolveContext;

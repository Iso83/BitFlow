...
namespace std {
template <typename Tag, typename ValueT> struct hash<BitFlow::Engine::Core::Ids::StrongId<Tag, ValueT>> {
    size_t operator()(const BitFlow::Engine::Core::Ids::StrongId<Tag, ValueT>& id) const noexcept {

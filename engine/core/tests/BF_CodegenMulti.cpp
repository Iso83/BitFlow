...
int main() {
    ...
    const std::vector<const Expr*> noSharing = {out1, out2};
    ...
    const std::vector<const Expr*> sharedOutputs = {sharedOut1, sharedOut2};
    ...
    const std::vector<const Expr*> leafOutputs = {leafVar, leafConst};
    ...
    const std::vector<const Expr*> nestedOutputs = {nestedOut1, nestedOut2};

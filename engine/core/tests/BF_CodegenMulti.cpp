...
int main() {
    ...
    const std::vector<const ExprOld*> noSharing = {out1, out2};
    ...
    const std::vector<const ExprOld*> sharedOutputs = {sharedOut1, sharedOut2};
    ...
    const std::vector<const ExprOld*> leafOutputs = {leafVar, leafConst};
    ...
    const std::vector<const ExprOld*> nestedOutputs = {nestedOut1, nestedOut2};

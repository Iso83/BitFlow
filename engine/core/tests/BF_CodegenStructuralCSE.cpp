...
int main() {
    ...
    auto x2 = MakeOp(101, OpType::Xor, {a, b}); // apart ExprOld*, wel structureel gelijk
    auto out1 = MakeOp(102, OpType::Add, {x1, c});
    auto out2 = MakeOp(103, OpType::And, {x2, d});
    const std::vector<const ExprOld*> outputs1 = {out1, out2};
    ...
    const std::vector<const ExprOld*> outputs2 = {sharedOut1, sharedOut2};
    ...
    const std::vector<const ExprOld*> outputs3 = {xorAB, xorBA};
    ...
    const std::vector<const ExprOld*> outputs4 = {n1, n2};
    ...
    const std::vector<const ExprOld*> outputs5 = {nestedOut1, nestedOut2};

...
int main() {
    ...
    const std::vector<const Expr*> outputs1 = {out1, out2};
    ...
    const std::vector<const Expr*> outputs2 = {sharedOut1, sharedOut2};
    ...
    const std::vector<const Expr*> outputs3 = {xorAB, xorBA};
    ...
    const std::vector<const Expr*> outputs4 = {n1, n2};
    ...
    const std::vector<const Expr*> outputs5 = {nestedOut1, nestedOut2};

...
int main() {
    ...
    BF_TEST(code1.find("uint64_t t1 = ") != std::string::npos);
    ...
    BF_TEST(code2.find("uint64_t t1 = ") != std::string::npos);
    ...
    BF_TEST(code3.find("uint64_t t1 = ") == std::string::npos);
    ...
    BF_TEST(code4.find("uint64_t t1 = ") != std::string::npos);
    ...
    BF_TEST(code5.find("uint64_t t1 = ") != std::string::npos);

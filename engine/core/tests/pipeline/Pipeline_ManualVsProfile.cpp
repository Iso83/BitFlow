...
int TestManualEqualsProfile_ShaSafe() {
    ...
    Expr* d0 = MakeVar(4);
    Expr* e0 = MakeVar(5);
    Expr* inProfile = MakeOp(10, OpType::Xor, {MakeOp(11, OpType::Ch, {a0, b0, c0}), MakeOp(12, OpType::Maj, {a0, d0, e0})});
    ...
    Expr* d1 = MakeVar(4);
    Expr* e1 = MakeVar(5);
    Expr* inManual = MakeOp(13, OpType::Xor, {MakeOp(14, OpType::Ch, {a1, b1, c1}), MakeOp(15, OpType::Maj, {a1, d1, e1})});

...
int AssertStableNoCycle(RuleEngine& engine, ExprOld* expr, int maxIterations) {
...
int Test_NoOscillation_BitwiseCommonFactor() {
    ...
    ExprOld* b = MakeVar(2);
    ExprOld* c = MakeVar(3);
    ExprOld* expr = MakeOp(100, OpType::Xor, {MakeOp(101, OpType::And, {a, b}), MakeOp(102, OpType::And, {a, c})});
...
int Test_NoOscillation_AndXor_WithoutDistribute() {
    ...
    ExprOld* expr = MakeOp(200, OpType::And, {a, MakeOp(201, OpType::Xor, {b, c})});
...
int Test_NoOscillation_AndXor_WithDistribute() {
    ...
    ExprOld* c = MakeVar(22);
    ExprOld* expr = MakeOp(300, OpType::And, {a, MakeOp(301, OpType::Xor, {b, c})});
...
int Test_NoOscillation_ArithmeticCommonFactor() {
    ...
    ExprOld* b = MakeVar(31);
    ExprOld* c = MakeVar(32);
    ExprOld* expr = MakeOp(400, OpType::Add, {MakeOp(401, OpType::Mul, {a, b}), MakeOp(402, OpType::Mul, {a, c})});
...
int Test_NoOscillation_ArithmeticGuardCase() {
    ...
    ExprOld* b = MakeVar(41);
    ExprOld* expr = MakeOp(500, OpType::Add, {a, MakeOp(501, OpType::Mul, {a, b})});
...
int Test_NoOscillation_FactorizeThenExpand_PipelineCombo() {
    ExprOld* a = MakeVar(60);
    ExprOld* b = MakeVar(61);
    ExprOld* c = MakeVar(62);
    ExprOld* distributed =
        MakeOp(700, OpType::Xor, {MakeOp(701, OpType::And, {a, b}), MakeOp(702, OpType::And, {a, c})});

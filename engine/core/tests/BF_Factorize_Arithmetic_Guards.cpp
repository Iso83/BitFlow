...
int AssertNoRewrite(RuleEngine& engine, ExprOld* expr, int maxIterations = 6) {
...
int TestGuard_a_plus_a_mul_b_unchanged() {
    ...
    ExprOld* a = MakeVar(1);
    ExprOld* b = MakeVar(2);
    ExprOld* expr = MakeOp(10, OpType::Add, {a, MakeOp(11, OpType::Mul, {a, b})});
...
int TestGuard_a_plus_a_shift_1_unchanged() {
    ...
    ExprOld* expr = MakeOp(21, OpType::Add, {a, MakeOp(22, OpType::Shl, {a, MakeConst(23, 1)})});
...
int TestGuard_a_mul_b_plus_c_standalone_unchanged() {
    ...
    ExprOld* expr = MakeOp(33, OpType::Mul, {a, MakeOp(34, OpType::Add, {b, c})});
...
int TestGuard_nonlinear_mix_unchanged() {
    ...
    ExprOld* expr = MakeOp(41, OpType::Add, {a, MakeOp(42, OpType::Mul, {a, a})});

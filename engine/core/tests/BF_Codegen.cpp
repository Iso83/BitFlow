...
int main() {
    ...
    BF_TEST(mulOverAddCode == "(((((((((v1) & 0xffffffffu) + ((v2) & 0xffffffffu)) & 0xffffffffu)) * "
    ...
    BF_TEST(notXorCode == "((((~(((((v1) & 0xffffffffu) ^ ((v2) & 0xffffffffu)) & 0xffffffffu))) & "
    ...
    BF_TEST(andOverXorCode == "(((((((((v1) & 0xffffffffu) ^ ((v2) & 0xffffffffu)) & 0xffffffffu)) & "
                              "((v3) & 0xffffffffu)) & 0xffffffffu)) & 0xffffffffu)");

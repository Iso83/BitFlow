...
Rule Get_Mul_One_Rule() {
    return Rule{RuleId::Simplify_MulOne, &Match_Mul_One, &Rewrite_Mul_One, Stage_Simplify, {RuleId::Normalize_Flatten}, RuleFlags::Arithmetic, "Simplify_MulOne"};
}

Rule Get_Div_One_Rule() {
    return Rule{RuleId::Simplify_DivOne, &Match_Div_One, &Rewrite_Div_One, Stage_Simplify, {RuleId::Normalize_Flatten}, RuleFlags::Arithmetic, "Simplify_DivOne"};
}

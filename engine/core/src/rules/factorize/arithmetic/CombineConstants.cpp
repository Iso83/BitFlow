...
static bool Match_MulCombineConstants(const ExprStore* store, const ExprNameMap* names, ExprId id) {
...
static ExprId Rewrite_MulCombineConstants(RewriteContext& ctx, const ExprNameMap* names, ExprId id) {
    ExprStore* store = ctx;
    const Expr& e = (*store)[id];
